    ...
    <>
      <div style={styles.container}>
        ...
        <div style={styles.sidebar}>
          ...
          />
          <button style={styles.sidebarLink} onClick={() => navigate('/hotel')}>
            Add Room
          </button>
          <button
          ...
          <button style={styles.sidebarLink} onClick={() => navigate('/rooms')}>
            Manage Rooms
          </button>
        </div>
            ...
            <div style={styles.bookingList}>
              {bookings.map(booking => (
                <div key={booking._id} style={styles.bookingCard}>
                  ...
                  {/* Show coordinates if location is present and valid */}
                  {(() => {
                    const loc = booking.room?.location
                    if (
                      loc &&
                      typeof loc === 'object' &&
                      ...
                      return (
                        <p style={styles.bookingInfo}>
                          <strong>Coordinates:</strong> [{loc.coordinates[1]},{' '}
                          {loc.coordinates[0]}]
                        </p>
                      )
                    }
